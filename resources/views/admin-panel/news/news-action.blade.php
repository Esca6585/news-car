<span class="dtr-data d-flex">
    <a href="{{ route(Request::segment(2) . '.show', [ $new->id ] ) }}"
    ...
    <a href="{{ route(Request::segment(2) . '.edit', [ $new->id ] ) }}"
    ...
    <form action="{{ route(Request::segment(2) . '.destroy', [ $new->id ] ) }}"
        ...
        <div class="example-preview">
            <!--begin::Modal-->
            <div class="modal fade" id="exampleModalSizeSm-{{$new->id}}" tabindex="-1"
                aria-labelledby="exampleModalSizeSm-{{$new->id}}" style="display: none;" aria-hidden="true">
