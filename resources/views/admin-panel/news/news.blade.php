...
<body id="kt_body"
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin: Datatable-->
                                    @include('admin-panel.news.news-table')
                                    <!--end: Datatable-->
                                </div>
                            </div>
                            <!--end::Card-->
    ...
    <script src="{{ asset('metronic-template/v7/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}"></script>
