                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">
                                                {{ __( ucfirst(Request::segment(2)) . ' Categories') }}
                                            </a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        <div class="col-xxl-5 mb-11 mb-xxl-0">
                                            ...
                                            <div class="card card-custom card-stretch">
                                                <div class="card-body p-0 rounded px-10 py-15 d-flex align-items-center justify-content-center"
                                                    ...
                                                    @if($news->image)
                                                    <img src="{{ asset($news->image) }}" class="mw-100 w-200px"
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            ...
                                            <h5>
                                                <a href="{{ route('category.show', [ 'all', $news->category_id ] ) }}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <textarea class="summernote" id="kt_summernote_1" name="body">{{ $news->body }}</textarea>
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    <a href="{{ route('news.index') }}" class="btn btn-sm btn-clean btn-icon mr-2">
                                        <span class="svg-icon svg-icon-xl">
                                    ...
                                    <a href="{{ route(Request::segment(2) . '.edit', [ $news->id ] ) }}"
