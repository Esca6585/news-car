...
<body id="kt_body"
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('news.index') }}" class="text-muted">{{ __('News') }}</a>
                                        </li>

                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('news.index') }}" class="text-muted">
                                                {{ __('News') }}
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                <!--begin::Form-->
                                @if($news->id)
                                <form action="{{ route(Request::segment(2) . '.update', [ $news->id ] ) }}"
                                    ...
                                    <form action="{{ route(Request::segment(2) . '.store' ) }}" method="post"
                                        ...
                                        <div class="card-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $news->title ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('title') : '' }}" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="{{ $parentCategory->id }}"
                                                                    {{ $parentCategory->id == $news->category_id ? 'selected=selected' : '' }}>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="tag" placeholder="{{ __('Tag') }}"
                                                                value="{{ $news->tag ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('tag') : '' }}" />

                                                            @error('tag')
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                                <div data-field="tag" data-validator="notEmpty">
                                                                    {{ $message }}
                                                                </div>
                                                            </div>
                                                            @enderror
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <textarea class="summernote" id="kt_summernote_1" name="body">{{ $news->body ?? old('body') }}</textarea>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $news->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $news->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($news->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $news->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $news->id ? 'text-dark' : '' }}">
                                                    {{ $news->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
    ...
    <script src="{{ asset('metronic-template/v7/assets/js/pages/crud/forms/editors/summernote.js') }}"></script>
