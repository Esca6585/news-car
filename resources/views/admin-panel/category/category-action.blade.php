<span class="dtr-data d-flex">
    <a href="{{ route(Request::segment(3) . '.show', [ $categoryType, $category->id ] ) }}"
    ...
    <a href="{{ route(Request::segment(3) . '.edit', [ $categoryType, $category->id ] ) }}"
    ...
    <form action="{{ route(Request::segment(3) . '.destroy', [ $categoryType, $category->id ] ) }}"
        method="post">
        @method('delete')
        @csrf

        <button type="button" class="btn btn-sm btn-clean btn-icon" title="{{ __('Delete') }}" data-toggle="modal"
            data-target="#exampleModalSizeSm-{{$category->id}}">
        ...
        <div class="example-preview">
            <!--begin::Modal-->
            <div class="modal fade" id="exampleModalSizeSm-{{$category->id}}" tabindex="-1"
                aria-labelledby="exampleModalSizeSm-{{$category->id}}" style="display: none;" aria-hidden="true">
