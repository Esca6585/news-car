                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('category.index', [ 'all' ]) }}"
                                                class="text-muted">{{ __('Categories') }}</a>
                                        </li>

                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('category.index', [ $categoryType ]) }}"
                                                class="text-muted">
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($category->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ $categoryType, $category->id ] ) }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    @else
                                    <form
                                        action="{{ route(Request::segment(3) . '.store', [ $categoryType ] ) }}"
                                        method="post" enctype="multipart/form-data">
                                        @csrf
                                        @endif
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="name"
                                                                placeholder="{{ __('Name') }}"
                                                                value="{{ $category->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="exampleSelect1" name="category_id">
                                                                ...
                                                                <option value="{{ $parentCategory->id }}" {{ $parentCategory->id == $category->category_id ? 'selected=selected' : '' }}>{{ $parentCategory->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
