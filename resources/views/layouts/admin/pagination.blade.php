...
<div class="example-preview">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div class="d-flex flex-wrap py-2 mr-3">
            ...
            <a class="btn btn-icon btn-sm border-0 btn-light btn-hover-primary active mr-2 my-1 page-link">{{ $element }}</a>
            @endif
            ...
            <a class="btn btn-icon btn-sm border-0 btn-light active mr-2 my-1 page-link">{{ $page }}</a>
            @else
